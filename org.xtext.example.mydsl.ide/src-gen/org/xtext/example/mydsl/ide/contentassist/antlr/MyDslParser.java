...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFSMAccess().getGroup_3_1(), "rule__FSM__Group_3_1__0");
			builder.put(grammarAccess.getFSMAccess().getGroup_3_1_2(), "rule__FSM__Group_3_1_2__0");
			...
			builder.put(grammarAccess.getFSMAccess().getInitialstateAssignment_2(), "rule__FSM__InitialstateAssignment_2");
			...
			builder.put(grammarAccess.getFSMAccess().getTransitionAssignment_3_1_1(), "rule__FSM__TransitionAssignment_3_1_1");
			builder.put(grammarAccess.getFSMAccess().getTransitionAssignment_3_1_2_1(), "rule__FSM__TransitionAssignment_3_1_2_1");
			builder.put(grammarAccess.getState_ImplAccess().getIsFinalAssignment_1(), "rule__State_Impl__IsFinalAssignment_1");
			...
			builder.put(grammarAccess.getInitialStateAccess().getIsFinalAssignment_2(), "rule__InitialState__IsFinalAssignment_2");
