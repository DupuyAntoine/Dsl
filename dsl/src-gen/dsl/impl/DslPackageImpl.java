...
public class DslPackageImpl extends EPackageImpl implements DslPackage {
	...
	public static DslPackage init() {
		...
		DslPackageImpl theDslPackage = registeredDslPackage instanceof DslPackageImpl
				? (DslPackageImpl) registeredDslPackage
				: new DslPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, dsl.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFSM_Name(), ecorePackage.getEString(), "name", null, 0, 1, dsl.FSM.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_State(), this.getState(), null, "state", null, 0, -1, dsl.FSM.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getFSM_Transition(), this.getTransition(), null, "transition", null, 0, -1, dsl.FSM.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_Initialstate(), this.getInitialState(), null, "initialstate", null, 1, 1, dsl.FSM.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
